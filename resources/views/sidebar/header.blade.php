<div class="col-lg-12 pt-2 pl-3 border-bottom">
    <div class="d-flex flex-row">
        <div class="flex-grow-1 text-left font-weight-bold">
            <div class="d-flex flex-row">
                <div class="">
                    <p href="#" class=" text-sm"  onclick="openNav()">
            ...
            <div id="mySidenav" class="sidenav">
                <div class="d-flex flex-row p-2">
                    <div class="flex-grow-1">
                        <p class="font-weight-bold"> Account info</p>
                    </div>
                    <div class="">
                ...
                <div class="d-flex flex-row">
                    <div class="">
                        <img class="pl-2" onclick="openNav()" src='https://avataaars.io/?avatarStyle=Circle&topType=LongHairStraight&accessoriesType=Blank&hairColor=BrownDark&facialHairType=Blank&clotheType=BlazerShirt&eyeType=Default&eyebrowType=Default&mouthType=Default&skinColor=Light' alt="imagefrined" class="rounded-full mr-3" width="40px" >

                    </div>
                    <div class="{{ route('profile',auth()->user()->username ) }} ">
                        <a href="" class="">{{ auth()->user()->name }}<br>
