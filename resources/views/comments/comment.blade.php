@forelse ($tweetcomments as $tweetcomment)
@if($tweet->id === $tweetcomment->tweet_id)
@if($tweetcomment->user_id === $user->id)
<div class="row">
    <div class="col-lg-12  {{ $loop->last ? 'border-bottom p-2':'' }}">
        <div class="d-flex">
            <div class="flex-grow-1 text-truncate">
                <div class="d-flex flex-row text-break ">
                    ...
                    <div class="p-1 text-truncate">
                        @if(auth()->user()->id == $tweetcomment->user_id)
                        @else
                            @include('button.app')
                        @endif
                    </div>
                ...
                <div class="pl-3">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <a href="#" class="text-decoration-none text-dark">
                                    <img src="{{$tweetcomment->image}}" class="img-thumbnail">
                                </a>
                                <a href="{{ route('profile',$tweet->user ) }} " class="text-muted">
                                    Replying to: <span class="text-primary">{{ '@' }}{{ $tweet->user->username }}</span>
                                </a>
                    ...
                    @if($tweetcomment->gif != null)
                        <div class="row">
                            <div class="col-lg-12">
                                <a href="#" class="text-decoration-none text-dark">
                                    <img src="{{$tweetcomment->gif}}" class="img-thumbnail">
                                </a>
