<div class="row">
    ...
    <div class="col-lg-12 m-2 pl-5">
        <span class="text-muted">Replying to</span><a href="{{ route('profile',$tweet->user ) }}" class="text-primary">
            {{ '@' }}{{ $tweet->user->username }}
        </a>
    </div>
    ...
    <div class="col-lg-12 mt-2">
        <div class="d-flex flex-row">
            ...
            <div class="flex-grow-1 text-truncate font-weight-bold">
                <form method="POST" action="/tweets/{{$tweet->id}}/commets" enctype="multipart/form-data">
                    @csrf
                    <input type="text" value="{{$tweet->id}}" name="tweet_id" hidden>

                    <textarea class="form-control border-0"  placeholder="Tweet your reply" name="comment" autofocus></textarea>
